...
#' @author Subha Halder
UniAMAXstar <- function(sample_data, significance_level){
  set.seed(456)
  R_MLE <- function(X, n) {
    X1 <- X[-1]
    n1 <- n[-1]
  ...
  return(paste("Peak:", h, "; UniAMAX* Critical value:", quantile_value, "; UniAMAX* Test statistic:", Aunimax, "; Result:", result))
}
